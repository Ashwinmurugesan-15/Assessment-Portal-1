...
export default function ExaminerLearningPage() {
    ...
    const handleDelete = async (id: string, title: string) => {
        ...
        try {
            const res = await fetch(getApiUrl(`/learning/${id}?user_role=${currentUser.role}`), {
                method: 'DELETE'
            });
                ...
                <div className="max-w-7xl mx-auto px-6 py-12">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Manage course materials for candidates</p>
                        </div>
                        {!showForm && (
                            <button
                                onClick={() => {
                        ...
                        <div className="grid gap-6">
                            {resources.map((resource) => (
                                <LearningResourceCard
                                    ...
                                    onDelete={() => handleDelete(resource.id, resource.title)}
